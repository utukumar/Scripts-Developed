...
# data frame to excel
required_issues_df.to_excel(r"CC:\Users\utukumar\Documents\Scripts\dist\Daily mail AP-QS\indianConsumerBusinnes\icb_new\sortingRequiredIssues\output.xlsx", index=False)

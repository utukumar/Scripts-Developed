...
icb_qs_tag = 'ICB_QS'
icb_testcase_tag = 'ICB-TC'
icb_adhoc_tag = 'ICB-Adhoc'
icb_triaged_tag = 'ICB-QS-Triaged'
...
# Custom field
icb_resolution_string = 'Fixed'
icb_root_cause = 'Bug - Fixed'
...
icb_issues_missing_info = []

# list of issues with no missing information
icb_issues_no_missing_info = []
    ...
    if icb_adhoc_tag not in df.iloc[i, 9]:
        if adhoc_label in df.iloc[i, 10]:
            if gdq_label in df.iloc[i, 10] and icb_qs_tag in df.iloc[i, 9]:
                if icb_testcase_tag not in df.iloc[i, 9]:
                    if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                        result_dict = {
                            ...
                            'Custom Resolution':'{scenario}'.format(scenario = 'Fixed Resolution is present with Bug-Fixed Root Cause' if (icb_root_cause in df.iloc[i,12] and icb_resolution_string in df.iloc[i,12]) else "NA")
                        }
                ...
                elif icb_testcase_tag in df.iloc[i, 9]:
                    if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                        result_dict = {
                            'User Alias': df.iloc[i, 4],
                            'Issue URL': df.iloc[i, 8],
                ...
                if df.iloc[i, 0] not in icb_seen_dict:
                    icb_seen_dict[df.iloc[i, 0]] = 1
                print('Here 141', df.iloc[i, 0])

                # appending the result_dict to icb_issues_missing_info list
                icb_issues_missing_info.append(result_dict)

            elif gdq_label not in df.iloc[i, 10] and icb_qs_tag in df.iloc[i, 9]:
                if icb_testcase_tag not in df.iloc[i, 9]:
                    if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                        result_dict = {
                            'User Alias': df.iloc[i, 4],
                ...
                if df.iloc[i, 0] not in icb_seen_dict:
                    icb_seen_dict[df.df.iloc[i, 0]] = 1
                print('Here 218', df.iloc[i, 0])
                icb_issues_missing_info.append(result_dict)

            elif gdq_label in df.iloc[i, 10] and icb_qs_tag not in df.iloc[i, 9]:
                if icb_testcase_tag not in df.iloc[i, 9]:
                    if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                        result_dict = {
                            'User Alias': df.iloc[i, 4],
                            ...
                            'Tags Present': df.iloc[i, 9],
                            'Missing Tag': "{tag1} and {tag2} are missing {mis}".format(tag1=icb_adhoc_tag, tag2=icb_qs_tag, mis='and '+"QS_Regression or QS_Newfeature or QS_Nonfunctional is missing." if 'QS_Regression' not in df.iloc[i, 9] and 'QS_Newfeature' not in df.iloc[i, 9]  and 'QS_Nonfunctional' not in df.iloc[i, 9]  else "").rstrip(),
                            'Custom Resolution':'{scenario}'.format(scenario = 'Fixed Resolution is present with Bug-Fixed Root Cause' if (icb_root_cause in df.iloc[i,12] and icb_resolution_string in df.iloc[i,12]) else "NA")
                        }
                    elif 'Open' in df.iloc[i, 3] and valid_label in df.iloc[i, 10]:
                        result_dict = {
                    ...
                    if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                        result_dict = {
                            ...
                            'Tags Present': df.iloc[i, 9],
                            'Missing Tag': "{tag1} is missing {mis}".format(tag1=icb_qs_tag, tag2=icb_qs_tag, mis='and '+"QS_Regression or QS_Newfeature or QS_Nonfunctional is missing." if 'QS_Regression' not in df.iloc[i, 9] and 'QS_Newfeature' not in df.iloc[i, 9]  and 'QS_Nonfunctional' not in df.iloc[i, 9]  else "").rstrip(),
                            'Custom Resolution':'{scenario}'.format(scenario = 'Fixed Resolution is present with Bug-Fixed Root Cause' if (icb_root_cause in df.iloc[i,12] and icb_resolution_string in df.iloc[i,12]) else "NA")
                        }
                    elif 'Open' in df.iloc[i, 3] and valid_label in df.iloc[i, 10]:
                        result_dict = {
                ...
                icb_issues_missing_info.append(result_dict)
    elif icb_adhoc_tag in df.iloc[i, 9]:
        if adhoc_label not in df.iloc[i, 10]:
            ...
            elif gdq_label not in df.iloc[i, 10]  and icb_qs_tag not in df.iloc[i, 9]:
                if testcase_label not in df.iloc[i, 10]:
                    if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                        result_dict = {
                            'User Alias': df.iloc[i, 4],
                            ...
                            'Tags Present': df.iloc[i, 9],
                            'Missing Tag': "{tag1} is missing {mis}".format(tag1=icb_qs_tag, mis="and "+"QS_Regression or QS_Newfeature or QS_Nonfunctional is missing." if 'QS_Regression' not in df.iloc[i, 9] and 'QS_Newfeature' not in df.iloc[i, 9]  and 'QS_Nonfunctional' not in df.iloc[i, 9]  else "").rstrip(),
                            'Custom Resolution':'{scenario}'.format(scenario = 'Fixed Resolution is present with Bug-Fixed Root Cause' if (icb_root_cause in df.iloc[i,12] and icb_resolution_string in df.iloc[i,12]) else "NA")
                        }
                    elif 'Open' in df.iloc[i, 3] and valid_label in df.iloc[i, 10]:
                        result_dict = {
            ...
            if gdq_label in df.iloc[i, 10] and icb_qs_tag in df.iloc[i, 9]:
                if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                    ...
                    if df.iloc[i, 0] not in icb_seen_dict:
                        ...
                        if 'Resolved' in df.iloc[i, 3] and (valid_label in df.ilo[i, 10] or invalid_label in df.iloc[i, 10]) and icb_triaged_tag in df.iloc[i, 9]:
                            result_dict = {
                                        'User Alias': df.iloc[i, 4],
                                        'Issue URL': df.iloc[i, 8],
                                        'Status': df.iloc[i, 3],
                            ...
                            icb_issues_no_missing_info.append(result_dict)
            elif gdq_label not in df.iloc[i, 10] and icb_qs_tag in df.iloc[i, 9]:
                if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                    result_dict = {
                        'User Alias': df.iloc[i, 4],
...
for i in range(len(df)):
    if icb_adhoc_tag not in df.iloc[i, 9]:
        if adhoc_label not in df.iloc[i, 10]:
            if testcase_label not in df.iloc[i, 10]:
                if gdq_label in df.iloc[i, 10] and icb_qs_tag in df.iloc[i, 9]:
                    if icb_testcase_tag in df.iloc[i, 9]:
                        if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                            result_dict = {
                                'User Alias': df.iloc[i, 4],
                                'Issue URL': df.iloc[i, 8],
                    ...
                    elif icb_testcase_tag not in df.iloc[i, 9]:
                        if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                            result_dict = {
                                'User Alias': df.iloc[i, 4],
                                'Issue URL': df.iloc[i, 8],
                    ...
                    if icb_testcase_tag in df.iloc[i, 9]:
                        ...
                        if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                            result_dict = {
                                ...
                                'Tags Present': df.iloc[i, 9],
                                'Missing Tag': "{tag1} is missing. No Adhoc or TC tag is present  {mis}".format(tag1=icb_qs_tag, mis="and "+"QS_Regression or QS_Newfeature or QS_Nonfunctional is missing." if 'QS_Regression' not in df.iloc[i, 9] and 'QS_Newfeature' not in df.iloc[i, 9]  and 'QS_Nonfunctional' not in df.iloc[i, 9]  else "").rstrip(),
                                'Custom Resolution':'{scenario}'.format(scenario = 'Fixed Resolution is present with Bug-Fixed Root Cause' if (icb_root_cause in df.iloc[i,12] and icb_resolution_string in df.iloc[i,12]) else "NA")
                            }
                        elif 'Open' in df.iloc[i, 3] and valid_label in df.iloc[i, 10]:
                            result_dict = {
...
for i in range(len(df)):
    if df.iloc[i, 0] not in icb_seen_dict:
        if testcase_label in df.iloc[i, 10] and icb_testcase_tag in df.iloc[i, 9]:
            # checking for gdq_label is present and qs_tag is not present
            if gdq_label in df.iloc[i, 10] and icb_qs_tag not in df.iloc[i, 9]:
                if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                    result_dict = {
                                'User Alias': df.iloc[i, 4],
                                'Issue URL': df.iloc[i, 8],
                ...
                icb_issues_missing_info.append(result_dict)
            elif gdq_label not in df.iloc[i, 10] and icb_qs_tag in df.iloc[i, 10]:
                if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                    result_dict = {
                        'User Alias': df.iloc[i, 4],
                        'Issue URL': df.iloc[i, 8],
                ...
                icb_issues_missing_info.append(result_dict)
            elif gdq_label in df.iloc[i, 10] and icb_qs_tag in df.iloc[i, 9]:
                if 'Open' in df.iloc[i, 3] and invalid_label in df.iloc[i, 10]:
                    result_dict = {
                        'User Alias': df.iloc[i, 4],
                        'Issue URL': df.iloc[i, 8],
                    ...
                    if df.iloc[i, 0] not in icb_seen_dict:
                        if df.iloc[i, 2] not in ["High", "Medium", "Low"]:
                            ...
                            if ('Resolved' in df.iloc[i, 3]) and (valid_label in df.iloc[i, 10] or invalid_label in df.iloc[i, 10]) and icb_triaged_tag in df.iloc[i, 9]:
                                result_dict = {
                                    'User Alias': df.iloc[i, 4],
                                    'Issue URL': df.iloc[i, 8],
                                    'Status': df.iloc[i, 3],
...
for i in range(len(df)):
    if 'Resolved' in df.iloc[i, 3]:
        if valid_label not in df.iloc[i, 10] and invalid_label not in df.iloc[i, 10]:
            if icb_triaged_tag not in df.iloc[i, 9]:
                if icb_root_cause in df.iloc[i,12] and icb_resolution_string not in df.iloc[i,11]:
                    result_dict = {
                                'User Alias': df.iloc[i, 4],
                                'Issue URL': df.iloc[i, 8],
                                'Status': df.iloc[i, 3],
                                ...
                                'Tags Present': df.iloc[i, 9],
                                'Missing Tag': "{tag1} is missing {mis}".format(tag1 = icb_triaged_tag, mis="QS_Regression or QS_Newfeature or QS_Nonfunctional is missing." if 'QS_Regression' not in df.iloc[i, 9] and 'QS_Newfeature' not in df.iloc[i, 9]  and 'QS_Nonfunctional' not in df.iloc[i, 9]  else "").rstrip(),
                                'Custom Resolution':f'{icb_resolution_string} Resolution is missing.'
                            }
                elif icb_root_cause in df.iloc[i,12] and icb_resolution_string in df.iloc[i,11]:
                    result_dict = {
                                'User Alias': df.iloc[i, 4],
                                'Issue URL': df.iloc[i, 8],
                                'Status': df.iloc[i, 3],
            ...
            elif icb_triaged_tag in df.iloc[i, 9]:
                if icb_root_cause in df.iloc[i,12] and icb_resolution_string not in df.iloc[i,11]:
                    result_dict = {
                        'User Alias': df.iloc[i, 4],
                        'Issue URL': df.iloc[i, 8],
...
missing_df = pd.DataFrame(icb_issues_missing_info)
no_missing_info_df = pd.DataFrame(icb_issues_no_missing_info)
...
if icb_issues_missing_info and icb_issues_no_missing_info:
    email_msg = '''
                <html>
                <head>
    ...
    server.sendmail(from_, to_, msg.as_string())
    server.quit()
elif icb_issues_no_missing_info:
    email_msg = '''
                <html>
                <head>
                <title>Weekly SIM Metrics</title>
